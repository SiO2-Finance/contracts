...
// File contracts/interfaces/IStakedSiO2.sol

interface IStakedSiO2 {
...
abstract contract GovernancePowerDelegationERC20 is ERC20, IGovernancePowerDelegationToken {
   ...
   * In this initial implementation with no SiO2 minting, simply returns the current supply
   * A snapshots mapping will need to be added in case a mint function is added to the SiO2 token in the future
   **/
   ...
   * the SiO2 token and StakeToken already include a mapping for the snapshots, so we require contracts
